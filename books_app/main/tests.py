...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        created_author = Author.query.filter_by(name='test author name').one()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.biography, 'this is a test biography')
    ...
    def test_create_genre(self):
        ...
        # Make sure genre was updated as we'd expect
        created_genre = Genre.query.filter_by(name='test genre name').one()
        self.assertIsNotNone(created_genre)
        self.assertEqual(created_genre.name, 'test genre name')
    ...
    def test_favorite_book(self):
        ...
        # Make sure users favorite books contain what we expect
    ...
    def test_unfavorite_book(self):
        ...
        # Make POST request to add book with id 1 to the users favorites
        self.app.post('/favorite/1')

        # Make POST request to remove book with id 1 to the users favorites
